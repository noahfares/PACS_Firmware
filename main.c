...
void send_xbee_transmit_request(uint16_t var1, uint16_t var2, uint16_t var3, uint16_t var4) {
...
void read_light_sensor() {
    ...
    while (UCB0CTL1 & UCTXSTT); // Wait for transmission to complete
